...
import { updateUserStart,updateUserFailure,updateUserSuccess, deleteUserStart,deleteUserSuccess, deleteUserFailure, signOutUserStart, signOutUserFailure, signOutUserSuccess } from '../redux/user/userSlice'
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4' action="">
        ...
        <img 
          ...
          <p className='text-sm self-center'>
            {fileUploadError?(
              <span className='text-red-700'>Error image upload(Image must be less tham 2mb)</span>
          ...
          {userListings.map((listing) => (
            ...
            >
              ...
              <div className='flex flex-col item-center'>
                ...
                <p className='text-red-700 mt-5'>
                {showListingsError ? 'Error deleting' : ''}
                </p>
                </div>
            </div>
          ))}
